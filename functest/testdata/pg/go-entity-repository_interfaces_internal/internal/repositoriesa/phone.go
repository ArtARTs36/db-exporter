...
type PhoneRepository interface {
	Get(ctx context.Context, filter *GetPhoneFilter) (*entitiesa.Phone, error)
	List(ctx context.Context, filter *ListPhoneFilter) ([]*entitiesa.Phone, error)
	Create(ctx context.Context, phone *entitiesa.Phone) (*entitiesa.Phone, error)
	Update(ctx context.Context, phone *entitiesa.Phone) (*entitiesa.Phone, error)
